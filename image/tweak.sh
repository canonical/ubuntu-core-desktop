...
mount -o loop,offset=$(expr 512 \* $(fdisk -l output/ubuntu-core-desktop-22-amd64.img |grep img3 | awk '{print $2}')) output/ubuntu-core-desktop-22-amd64.img $PWD/output/mnt
